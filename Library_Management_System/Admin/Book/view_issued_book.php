...
$student_id= "";
$student_name = "";
$query = "select issued_books.book_name,issued_books.author_name,issued_books.book_no,issued_books.student_id,users.name from issued_books left JOIN users on issued_books.student_id = users.id";
