...
$book_no = "";
$price = "";
$query = "SELECT book_name, author_name, book_price, book_no FROM books";
?>
...
<head>
    ...
    <script type="text/javascript" src="../../bootstrap-4.4.1/js/jquery_latest.js"></script> <!-- Fixed typo in the script source -->
    ...
    <style type="text/css">
        #side_bar {
            ...
            padding: 50px;
            width: 300px;
            height: 450px; /* Fixed typo: removed the space between 450 and px */
        }
