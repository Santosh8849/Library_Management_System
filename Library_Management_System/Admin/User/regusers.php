                    ...
                    <table class="table-bordered" width="900px" style="text-align:center">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                <button class="btn" name=""><a href="edituser.php?bn=<?php echo $row['id']; ?>">Edit</a></button>
                                <button class="btn" name=""><a href="deletuser.php?bn=<?php echo $row['id']; ?>">Delete</a></button>
                                </td> <!-- Links for edit and delete actions -->
